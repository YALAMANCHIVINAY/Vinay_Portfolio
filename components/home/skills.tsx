  ...
  const renderSectionTitle = (): React.ReactNode => (
    <div className="flex flex-col">
      ...
      <h2 className="text-2xl md:max-w-2xl w-full seq mt-2">
        I build production-ready AI and software solutions using modern
        programming, machine learning, cloud, database, and DevOps technologies.
      </h2>
    </div>
  );
    ...
    <section className="relative">
      ...
      >
        <div className="flex flex-col skills-wrapper">
          {renderSectionTitle()}
          <div className="mt-10">
            {renderSkillColumn("PROGRAMMING & DEVELOPMENT", SKILLS.programmingDevelopment)}
          </div>
          <div className="flex flex-wrap mt-10">
            <div className="mr-6 mb-6">
              {renderSkillColumn(
                "AI & MACHINE LEARNING",
                SKILLS.aiMachineLearning
              )}
            </div>
            <div>{renderSkillColumn("CLOUD, DATA & DEVOPS", SKILLS.cloudDataDevOps)}</div>
          </div>
        </div>
      </div>
    </section>
